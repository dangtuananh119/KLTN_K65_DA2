...
images = glob.glob('/home/trungle/catkin_ws/src/calibration/logitech/calib_images/*.jpg')
for fname in images:
...
np.savez('/home/trungle/catkin_ws/src/calibration/calib_savez', cameraMatrix=mtx, distCoef=dist, rVectors=rvecs, tVectors=tvecs)